@auth
    ...
    <script>
        (() => {
            ...
            const notifyBrowser = (title, body, tag = 'mrstudent-notification') => {
            ...
            const renderMessages = (messages) => {
                ...
                if (initialMessagesLoaded) {
                    ...
                    if (readMessage) {
                        ...
                        notifyBrowser('تمت قراءة رسالتك', 'فتح الطرف الآخر المحادثة واطلع على رسالتك.', `mrstudent-chat-read-${readMessage.id}`);
                    }
                } else {
