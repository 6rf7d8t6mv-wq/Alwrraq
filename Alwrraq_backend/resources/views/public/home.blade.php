@php
    ...
    $pageDescription = $isEnglish
        ...
        : 'الطباعة والتصوير وتجليد رسائل الماجستير والدكتوراه والمذكرات، ورفع ملفات PDF وWord وشراء القرطاسية مع التوصيل لجميع مناطق السعودية. فرعنا في المدينة المنورة.';
            ...
            [
                ...
                'hasOfferCatalog' => [
                    ...
                    'itemListElement' => collect([
                        'الطباعة والتصوير وتجليد رسائل الماجستير',
                        'الطباعة والتصوير وتجليد رسائل الدكتوراه',
    ...
    <main id="top">
        <section class="hero">
            <div class="container hero-grid">
                <div>
                    <span class="eyebrow">الطباعة والتصوير وتجليد الرسائل العلمية والمذكرات وخدمات القرطاسية</span>
                    <h1 class="hero-title" aria-label="الورّاق الأول في السعودية للطباعة والتصوير وتجليد الرسائل العلمية وبيع الخدمات القرطاسية وتوصلك لبيتك">
                        <span class="hero-title-line">الورّاق الأول في السعــودية للطباعـة والتصويـر</span>
                    ...
                    <p>منصة تخدم الدكتور والأستاذ والمعيد والمعلم والباحث والطالب وجميع الفئات في رفع الملفات، واختيار الطباعة والتصوير والتجليد، وشراء القرطاسية، ومتابعة الطلب من مكان واحد. فرعنا في المدينة المنورة ونوصل لجميع مناطق المملكة عبر شركة RedBox.</p>
                    <div class="hero-stats" aria-label="مميزات مختصرة">
                        ...
                        <div class="stat"><strong>خيارات دقيقة</strong><span>طباعة وتصوير وتجليد وتوصيل</span></div>
                    </div>
                </div>
        ...
        <section id="services">
            <div class="container">
                <div class="section-head">
                    <h2>خدماتنا</h2>
                    <p>خدمات أكاديمية وطباعة وتصوير وتجليد ومنتجات قرطاسية تخدم جميع الفئات في أنحاء المملكة، مع فرع في المدينة المنورة وشحن عبر RedBox.</p>
                </div>
                <div class="cards">
                    ...
                    <article class="card"><div class="card-icon">03</div><h3>الطباعة والتصوير وتجليد رسائل الماجستير</h3></article>
                    <article class="card"><div class="card-icon">04</div><h3>الطباعة والتصوير وتجليد رسائل الدكتوراه</h3></article>
        ...
        <section id="how-it-works">
            <div class="container">
                ...
                <div class="steps">
                    ...
                    <div class="step"><h3>اختر الإعدادات</h3><p>حدد الطباعة والتصوير والتجليد والعدد.</p></div>
